...
def main():
    parser = argparse.ArgumentParser(description="Hubryd RAG — CLI & API")
    parser.add_argument("--api", action="store_true", help="Start the FastAPI server instead of the CLI.")
